...
local function ruincacao_seed_cooked()
    local inst = CreateEntity()
    ...
    inst:AddComponent("inventoryitem")
    inst.replica.inventoryitem:SetImage("ruincacao_seed_cooked")
	inst.components.inventoryitem.atlasname= "images/tea_inventoryitem.xml"
    inst.components.inventoryitem.imagename= "ruincacao_seed_cooked"
...
local function ruincacao_seed()
	...
	inst:AddComponent("cookable")
    inst.components.cookable.product = "ruincacao_seed_cooked"
...
return Prefab("ruincacao_seed_cooked", ruincacao_seed_cooked, assets),
    Prefab("ruincacao_seed", ruincacao_seed, assets, {"ruincacao_seed_cooked"}),
	Prefab("ruincacao_bean", ruincacao_bean, assets),
	Prefab("ruincacao_seed_cooked", ruincacao_seed_cooked, assets),
    MakePlacer("ruincacao_seed_placer", "ruincacao_seed", "ruincacao_tree_seed", "planted"),
    Prefab("ruincacao_seed_sapling", ruincacao_seed_sapling, assets)