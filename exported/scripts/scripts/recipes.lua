...
for k, v in pairs(GLOBAL.AllRecipes) do
	if v.name == "fertilizer" then
		v.ingredients = {GLOBAL.Ingredient("poop", 3), GLOBAL.Ingredient("boneshard", 2), GLOBAL.Ingredient("bucket", 1, "images/tea_inventoryitem.xml","bucket.tex")}
	end
end
...
AddRecipe("bucket",{Ingredient("log",4)},RECIPETABS.DRINKS_TAB,TECH.NONE,nil,nil,nil,nil,nil,"images/tea_inventoryitem.xml","bucket.tex")
