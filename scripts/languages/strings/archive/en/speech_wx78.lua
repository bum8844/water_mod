return {
    ACTIONFAIL =
    {
        ...
        DESCRIBE =
        {
            ...
            APPLEPINE_JUICE = "DENIES ASSOCIATION WITH SPONGES", -- LEGION PINEAPPLE JUICE
            CITROYUZU_JUICE = "CRUSHED FOR CONSUMPTION", -- MORE FOOD PACK CITROYUZU JUICE
            ...
            LIMONSODA = "CONTAINS A LARGE AMOUNT OF CITRIC ACID", -- LEMON LIME SODA (FRUIT SODA UPGRADE)
            ...
            APPLEPINESODA = "PINE TUNING USED", -- CARBONATED PINEAPPLE (ORANCHI)
            CITROYUZUSODA = "PRODUCED TO ENCOURAGE THE BEHAVIOR OF ORGANISMS", -- CARBONATED CITROYUZU (FANTA)
