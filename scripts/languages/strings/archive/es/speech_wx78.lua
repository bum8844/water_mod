return {
    ACTIONFAIL =
    {
        ...
        DESCRIBE =
        {
            ...
            APPLEPINE_JUICE = "NO ASOCIADO CON LAS ESPONJAS", -- LEGION PINEAPPLE JUICE
            CITROYUZU_JUICE = "TRITURADO PARA CONSUMIRSE", -- MORE FOOD PACK CITROYUZU JUICE
            ...
            LIMONSODA = "CONTIENE UNA GRAN CANTIDAD DE ÁCIDO CÍTRICO", -- LEMON LIME SODA (FRUIT SODA UPGRADE)
            ...
            APPLEPINESODA = "PIÑA USADA", -- CARBONATED PINEAPPLE (ORANCHI)
            CITROYUZUSODA = "PRODUCIDO PARA MEJORAR EL COMPORTAMIENTO DE LOS ORGANISMOS", -- CARBONATED CITROYUZU (FANTA)
