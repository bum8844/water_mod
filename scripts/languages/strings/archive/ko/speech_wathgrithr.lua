return {
	...
	DESCRIBE =
	{
		...
		APPLEPINE_JUICE = "질긴 비늘을 찢고 과육을 갈아냈도다.", -- 레기온 파인애플 주스
		CITROYUZU_JUICE = "그 시큼한 과즙을 내 목으로 넘기라 하는건가!", -- 모어 푸드 팩 오랜지 주스
		...
		APPLEPINESODA = "솔방울이 들어갔건 과일이 들어갔건 옳지못하구나.", -- 탄산 파인애플(오란씨)
