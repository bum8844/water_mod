return {
	...
	DESCRIBE =
	{
		...
		APPLEPINE_JUICE = "이런 시큼한 과일주스는 마시기 힘들단 말일세.", -- 레기온 파인애플 주스
		CITROYUZU_JUICE = "여기 오기전에는 휴게실에 항상있던거 쳐다도 안봤는데 말일세.", -- 모어 푸드 팩 오랜지 주스
		...
		LIMONSODA = "이가 썩을것 같군.", -- 레몬 라임소다(과일소다 상위 호환)
		...
		APPLEPINESODA = "문명인에 더 가까워진듯한 기분이군.", -- 탄산 파인애플(오란씨)
		CITROYUZUSODA = "탄산이 강한건 매한가지로구먼.", -- 탄산 오랜지(환타)
