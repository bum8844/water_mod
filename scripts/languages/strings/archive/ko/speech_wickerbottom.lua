return {
    ...
    ANNOUNCE_CAFFINE_BUFF_START = "아데노신 수용체에 카페인이 결합하기 시작하는구나.", -- 카페인 버프 시작
    ANNOUNCE_CAFFINE_BUFF_STOP = "내 몸에서 카페인이 대사를 마쳤단다.",  -- 카페인 버프 끝
	...
	DESCRIBE =
	{
		...
		WELL_WATERPUMP_KIT = "깊은수맥에서 물을 퍼 올리기 위한 기계란다.", --스팀 물펌프 키트
		WELL_BURYING_KIT = "수맥이 비거나 더 이상 사용안 할때 메꾸는 도구들이지.", -- 구멍 매설 키트
		WELL_DRILLING = "수맥이 있는지 파보고 있어.", --드릴로 구멍 뚫는 중
		WELL_DRILLING_ITEM = "수맥이 있을 만한 적당한 장소를 찾아야겠어.", --드릴 아이템
		HOLE = "물소리가 들리는걸 보니 재대로 팠구나.", --우물 구멍
		WELL = "깊은수맥에서 물을 긷기위해 쓰는 건축물이지.", --우물

		WX78MODULE_NONEDRUNK = "유기체를 싫어하긴 하지만 유기체에게서 영감을 얻는건 싫어하지 않는것 같구나.", -- 78전용 묘듈

		-- 물 모드 식물

		TEA_TREE = "자그마한 동백나무의 일종 중 하나구나.",--차나무
		...
		CAFFEINBERRY = "달 토양에서 자란 낮은덤불이란다.", --커피 덤불
		DUG_CAFFEINBERRY = "커피 속과 후추속의 특징이 혼합되어있구나.", --파낸 커피덤불
		CAFFEINBERRY_BEAN = "향이 특이하구나.", --생 커피콩
		CAFFEINBERRY_BEAN_COOKED = "볶으니 진한 커피향과 약간의 후추향이 나는구나.", --구운 커피콩

		RUINCACAO_TREE = "열매가 싱크홀 아래로 떨어져 내린게 틀림없구나.", --카카오 나무
		...
		RUINCACAO_BEAN = "약간의 버터와 카카오빈으로 이루어져 있어.", --부순 후 카카오 콩  
		...
		ADDITIVE_PETALS = "리큐르에 잎과 꽃향을 나게 만들어 준단다.", -- 리큐르에 제조에 첨가 할 허브,녹차,꽃잎 첨가제
		ADDITIVE_NUT = "리큐르에 열매향을 나게 만들어 준단다.", -- 리큐르에 제조에 첨가 할 버치넛,코코넛,커피콩,카카오콩 첨가제
		ADDITIVE_DAIRY = "리큐르에 고소한향을 나게 만들어 준단다.", -- 리큐르에 제조에 첨가할 유제품 첨가제
		...
		GREENTEA = "아시아에서부터 유래되었단다.", --생잎 녹차
		BLACKTEA = "차 한잔과 좋은 책이 필요하단다.", --홍차
		...
		CAFFEINBERRY_JUICE = "난 커피 한잔과 책을 좋아한단다.", -- 블랙 커피
		...
		BUTTERBEER = "인기있는 소설의 음료구나, 진짜맥주는 아니란다.", --해리포터 시리즈의 버터비어
		...
		SWEET_RICE_DRINK = "발효되어서 단맛을내고 소화하기 편해졌단다.", -- 비타협 식혜
		APPLEPINE_JUICE = "브로멜린이 많아 입안이 헐수 있으니 적당히 마시자구나.", -- 레기온 파인애플 주스
		CITROYUZU_JUICE = "오렌지 주스구나, 주스의 스트레오 타입이라할수있지.", -- 모어 푸드 팩 오랜지 주스
		...
		SPOILED_DRINK = "마실것이 박테리아의 온상이 되어가고있어.", --썩은 음료

		-- 양조소다
	
		SODA = "이산화탄소가 용해되어 이온화된 물이란다.", -- 탄산수
		FRUITSODA = "탄산수에 과일즙이 첨가되어 있구나.", -- 과일소다
		LIMONSODA = "단맛이 꽤 강하구나.", -- 레몬 라임소다(과일소다 상위 호환)
		...
		GLOWBERRYWINE = "새로운 와인이구나, 발효과정에서 빛을 잃지 않는 이유를 알아봐야겠어.", --글로우 베리 와인
		KUMIS = "중앙 아시아의 전통주란다.", -- 크므즈,산양유주
		LUMPY_WINE = "아이슬란드에서 주로 담그는 술이란다.", --서주(감자 고구마등 뿌리 술)
		PULQUE = "메소아메리카 원주민들이 만드는 전통주란다.", --풀케(선인주)
		RUINCACAO_WINE = "못보던 양조주구나. 흥미로워.", -- 카카오 와인 

		-- 콜라보 소다

		CHERRY_DOCTOR_COLA = "23가지의 향신료가 들어간 웨츠빌 완치 음료구나.", --체리숲 닥터 페퍼(닥터 체리)
		APPLEPINESODA = "파인애플과즙이 들어간 탄산수구나.", -- 탄산 파인애플(오란씨)
		CITROYUZUSODA = "오렌지과즙이 들어간 탄산수구나.", -- 탄산 오랜지(환타)
		...
		CORN_WHISKEY = "아메리카대륙의 켄터키 지방의 버번위스키가 유명하단다.", -- 콘 위스키
		LUMPY_VODKA = "'작은 '물'을 의미하는 'вода'에서 유래했단다.", -- 보드카
		TEQUILA = "콩키스타도르들이 신대륙에 포도가 없자 아가베로 만든 메스칼이란다.", -- 데킬라
		...
		TEA_LUMPY_VODKA = "흥미롭군, 향의 밸런스는 잡혀 있는것 같구나.", -- 녹차 리큐르
        ...
        RUINCACAO_CREAM_LIQUEUR = "본래 남은 위스키와 크림을 싸게 처리하기 위해 만들어졌단다.", --베일리스 카카오 크림 리큐르
		...
		CHERRY_BLOOM_RUM = "아름답기도하지만 작용기전에도 관심이 가는구나.", -- 체리 꿀주 증류주 벛꽃잎이 떠다니는 술
		RICE_SPIRITS = "사케와 비슷하구나.", --청주
		WHEAT_WHISKEY = "아일랜드나 스코틀랜드에서 만들기 시작했단다.", -- 밀 위스키
		PALE_WHISKEY = "처음보는 위스키구나, 향은 꽤 독특해.", -- 페일 몰트 위스키

		--왈리 전용 콜라보 증류주

		NUT_COCONUT_BRANDY = "해적들 분위기를 내려 노력했구나.", -- 코코넛 브랜디 (캐러비안 럼을 만들수 없어서 카리브 브랜디 라는 이름으로 대체)
	    GIANT_BLUEBERRY_GIN = "재료의 본 성질을 생각하면 발효와 증류로 정 반대의 성질을 갖게했어.", -- 붐 베리 사파이어 (당근 폭발함)
        ...
        RUIN_SCHOKAKOLA = "새로운 종류의 초콜릿이구나! 각성물질이 강화되었구나.", -- 쇼카콜라
		...
		DESALINATOR =
		{
			...
			BURNT = "세상에, 저상태에서는 아무쓸모가 없겠구나.",   --제염기가 타버림
			HASSALT = "소금이 충분히 모였구나.", --제염기에 소금이 남아 있음
		},

		BARREL =
		{
			GENERIC = "물을 안전하게 보관하기 위해 숯이 첨가되었단다.", -- 물통 조사 대사
			BURNT = "오 이런, 물이 다 날아갔구나!", -- 물통이 타버림
		},

		BREWERY =
		{
			EMPTY = "식량의 장기보존을 위해 술을만들기 시작했단다.", --양조기 조사 대사
			BURNT = "한동안 발효에 관한 연구는 미뤄야 겠어.", --양조기 타버림
			FERMENTING_LONG = "이제 재료들이 발효되기를 인내 해야된단다.", --양조 끝나기 까지 많이 남음
			FERMENTING_SHORT = "발효가 거의 다되어가는구나!", --양조가 곧 끝남
			DONE = "멀리서도 향이 느껴지는구나.", --양조기에 음료가 들어있음
		},

		CAMPKETTLE_ITEM = "더러운물을 끓여서 박테리아를 박멸한단다.", --휴대 주전자 아이템 조사 대사
		CAMPKETTLE =
		{
			GENERIC = "비어 있단다.", -- 화덕에 건 휴대 주전자 안에 물이 없음
			BOILING_LONG = "소독이 되려면 아직 멀었어.", -- 물 끓이기 시작함
			BOILING_SHORT = "거의 다 소독되었구나!", -- 물 거의 다 끓음
			DONE = "마실수 있게 소독이 되었단다.", --깨끗한 물이 들음
			STOP = "소독을 완료하려면 불을 더 지펴야겠어.", --화덕에 불이 없어서 더러운물이 끓지 않는 상태
		},
		...
		PORTABLEKETTLE_ITEM =
		{
			GENERIC = "어디서든 차를 준비할수 있겠구나.", -- 휴대용 주전자(아이템) 조사 대사
			...
			PURIFY_LONG = "소독이 될때까지 기다리자구나.", -- 더러운 물을 끓이기 시작한지 얼마 안됨
			PURIFY_SHORT = "거의 다 소독되었구나!", --더러운물을 거의 다 끓여감
			HASWATER = "흠, 내가 한번 차를 만들어 볼까.", -- 깨끗한 물이 차 있는 상태
			MELT_LONG = "얼음이 녹을떄까지 기다리자구나.", -- 얼음물을 녹이기 시작한지 얼마 안됨
			MELT_SHORT = "거의 다 녹았단다!", -- 얼음물을 거의 녹여감
		},
