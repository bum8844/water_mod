return {
	...
	DESCRIBE =
	{
		...
		APPLEPINE_JUICE = "마실땐 좋은데, 마시고 나면 입안이 얼얼해 질거야.", -- 레기온 파인애플 주스
		CITROYUZU_JUICE = "누가 마시고 있으면 양치를 권해봐야지.", -- 모어 푸드 팩 오랜지 주스
		...
		LIMONSODA = "꿀물은 따듯하게 마시는거라구.", -- 레몬 라임소다(과일소다 상위 호환)
		...
		APPLEPINESODA = "파인애플 과즙 탄 소다일 뿐이야.", -- 탄산 파인애플(오란씨)
		CITROYUZUSODA = "그저 특별할거 없는 오렌지 소다야.", -- 탄산 오랜지(환타)
