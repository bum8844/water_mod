return {
	...
	DESCRIBE =
	{
		...
		CITROYUZU_JUICE = "탕비실 냉장고에 이게 없는날을 본적이 없어.", -- 모어 푸드 팩 오랜지 주스
		...
		LIMONSODA = "이빨 썩겠는데.", -- 레몬 라임소다(과일소다 상위 호환)
		...
		APPLEPINESODA = "시판 탄산음료 파인애플맛이네.", -- 탄산 파인애플(오란씨)
		CITROYUZUSODA = "시판 탄산음료 오렌지맛이야.", -- 탄산 오랜지(환타)
