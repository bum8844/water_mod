return {
	ACTIONFAIL =
	{
		GIVE =
		{
			WELL_NOTEMPTY = "Have to remove the basin first.",
	...
	ANNOUNCE_NOTCHARGE = "Needs to 'get milk'. Heh, that was good.",
	ANNOUNCE_NOTHIRSTSLEEP = "I'm too thirsty to sleep.",
	ANNOUNCE_NOTHIRSTSIESTA = "I need a drink before bedtime.",
	ANNOUNCE_SLEEP_END = "Refreshing.",
	ANNOUNCE_THIRST = "How about a quick quench?",
	...
	ANNOUNCE_DCAPACITY_HALF = "Something's wrong...",

	DESCRIBE =
	{
		BOILBOOK = "Why not study one more book.",

		WATER_CLEAN_ICE = "It's frozen.",
		...
		WELL_SPRINKLER_KIT = "For a good 'regationship' with plants!",
		WELL_WATERPUMP_KIT = "High Draw Pump! It leads the water from low to high?",
		WELL_BURYING_KIT = "Better safe than falling in a hole!",
		WELL_DRILLING = "One well at a time!",
		WELL_DRILLING_ITEM = "Wanna dig a well Woby?",
		...
		DUG_CAFFEINBERRY = "The grown ups back at camp will like this.",
       ...
       -- 증류기 첨가제
		...
		VEGGIE_TEA = "This looks...healthy?",
		CARROT_TEA = "Poor carrot...but not really.",
		CACTUS_TEA = "Hope I don't get splinters in my mouth?",
		TOMATO_JUICE = "This looks like a vampire drink.",
		LUMPY_TEA = "Ew...this looks like dirt.",
		SEAWEED_SHAKE = "What if it starts growing inside me?",

		GREENTEA = "I think I saw a bug! Just kidding.",
		BLACKTEA = "Which dinosaur enjoys tea? Tea-Rex!",
		BLACKTEA_ICED = "Ice is in the pot-tea.",
		FUER = "I didn't know they would use water sprinklers.",
		...
		RUINXOCOLATL = "This is cocoa? Really?",
		...
		SWEET_RICE_DRINK = "Not a juice, not a tea!",
		...
		PINEANANASSODA = "We'll call it the Pinetree Pioneer Apple Soda.", -- 탄산 파인애플(오란씨)
		ORANGESODA = "What do you call it when an orange soda dreams? 오렌지소다가 꿈을 꾸면? Fanta-sy!", -- 탄산 오랜지(환타)
		STRAWBERRYSODA = "I've never seen strawberry soda before!", -- 탄산 딸기(웰치스 딸기)

		--콜라보 양조주

		AUROBOW = "I wanna drink that color. Maybe just a sip?", -- 난파선 오로보우,무지개 해파리주
		COCONUT_WINE = "Looks sweet!", -- 난파선 코코넛 와인
		CHERRY_BLOOM_MADHU = "Looks like alcohol in a gift shop!", -- 체리숲 벚꽃꿀주
		GIANT_BLUEBERRY_WINE = "At least they kept the boom.", -- 비타협 붐!베리 사파이어(불 붙히면 폭발함)
		RICE_WINE = "Probably not milk.", -- 비타협 막걸리
		WHEAT_BEER = "Looks like real beer!", -- 힙 오브 푸드 밀맥주
		PALE_BEER = "Now I know why grown ups call it pale ail.", -- 레기온 페일에일 (몬스트라 열매를 쓴 청록색 맥주)
        ...
        WHITE_RUINCOLATE = "I need to ration this!",
		...
		DISTILLERS =
		{   
		    EMPTY = "Complicated thingajigs!.", --증류기 조사 대사
			DISTILLTING_LONG = "This'll be a while.", --증류가 끝나기 까지 많이 남음
			DISTILLING_SHORT = "I think it's for alcohol?", --증류가 곧 끝남
			DONE = "I should tell the guys at camp drinks are ready.", --증류기에 음료가 들어있음
		},

		WELL_WATERPUMP = {
			HIGH_PRESSURE = "The power of steam is awesome!", -- 압력 최대
			MIDDLE_PRESSURE = "It's as good as Mr. Wolfgang!", -- 압력이 중간
			LOW_PRESSURE = "Does the thingajig need more food?", -- 압력이 거의 없을때
			RECHARG_PRESSURE = "We need to find a pond Woby.", -- 압력이 아예 없을때
		},
