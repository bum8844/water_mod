return {
    ACTIONFAIL =
    {
        GIVE =
        {
            WELL_NOTEMPTY = "Let's deal with the full bucket first.", -- 
            WELL_BUSY = "Oops, it seems the bucket is already on its way down.", -- 
        }
    },
    ...
    ANNOUNCE_CAFFINE_BUFF_START = "Ahh, I feel invigorated!", -- 
    ANNOUNCE_CAFFINE_BUFF_STOP = "I yearn for a freshly brewed espresso.", -- 
    ...
    DESCRIBE =
    {
        ...
        WATER_CLEAN_ICE = "Should I grind it finely to make shaved ice?", -- 
        WATER_DIRTY_ICE = "I can't use this dirty ice for cooking.", -- 
        ...
        ADDITIVE_SEED = "I'll add this to enhance the flavor of spirits.", -- 
        ADDITIVE_PETALS = "It adds a touch of elegance to spirits.", -- 
        ADDITIVE_NUT = "This will give the spirits a unique aroma.", -- 
        ADDITIVE_DAIRY = "Perfect for making beginner-friendly drinks.", -- 
        ...
        FRUITJUICE = "It's a blend of various fruit flavors!", -- 
        BERRIES_JUICE = "Simple, slightly tart, and sweet.", -- 
        POMEGRANATE_JUICE = "Its sharpness awakens the appetite!", -- 
        BANANA_JUICE = "A crowd-pleaser, no doubt.", --
        FIG_JUICE = "The seeds give it an interesting texture.", -- 
        DRAGONJUICE = "It's both mild and exotic, perfect for those who seek adventure.", -- 
        GLOWBERRYJUICE = "I made this juice with special berries.", -- 
        WATERMELON_JUICE = "The thirstier you are, the sweeter it tastes!", -- 

        VEGGIE_TEA = "Bitterness can be good for you.", -- 
        CARROT_TEA = "Even if it's not everyone's favorite, it's still healthy.", --
        CACTUS_TEA = "The flesh inside is a treat!", -- 
        TOMATO_JUICE = "A drink even vampires would enjoy!", -- 
        LUMPY_TEA = "The more I sip, the sweeter it becomes!", -- 
        SEAWEED_SHAKE = "I never thought could make a drink out of this...", --

        GREENTEA = "It's like a herbal tea, not bad at all.", -- 
        BLACKTEA = "I should bring some biscuits.", -- 
        BLACKTEA_ICED = "A refreshing iced tea, especially after a heavy meal.", -- 
        FUER = "Surprisingly, it has a pleasant aroma.", 
        MIXFLOWER = "It has a nice aroma and is good for calming nerves!", -- 
        HIBISCUSTEA = "I'd highly recommend it for our ladies.", --
        CACTUSFLOWER_TEA = "It's like drinking a piece of art.", -- 
        LOTUSTEA = "It's truly exotic and beautiful!", --
        SUSHIBISCUS = "This is a mockery of tea.", -- 
        MOON_BLOSSOM_TEA = "It has a unique taste.", -- 

        CAFFEINBERRY_JUICE = "From now on, I'll call it 'Blue Moon-tain'.", -- 
        TOFFEE_LATTE = "A sweet and nutty coffee for those looking for something easy to drink.", --
        RUINCHA_LATTE = "I miss a real Mocha Martini.", -- 

        HOTRUINCOLATE = "You can enjoy it anywhere for a relaxing feeling.", -- 
        RUINCOLATE_SMOOTHIE = "The chewy chocolate chips and ice are exceptional.", -- 
        ...
        APPLEPINE_JUICE = "Be careful not to drink too much, or My mouth will peel off.", -- 
        CITROYUZU_JUICE = "It's freshly squeezed CITROYUZU juice!", -- 
        ...
        SPOILED_DRINK = "It's way past its expiration date.", 

        -- Brewery Soda

        SODA = "It's carbonated water without any strange flavors.",
        FRUITSODA = "Refreshing fruitiness with a fizzy kick!", -- 
        LIMONSODA = "As refreshing as a honeydew!", -- 
        ...
        APPLEPINESODA = "This is the perfect drink to help you digest after a big meal." , -- 
        CITROYUZUSODA = "Refreshing after a meal!", 
        ...
        AREUHI = "Fresh and mild taste, but be careful not to overdo it.", --
        ...
        NUT_COCONUT_BRANDY = "It would be great to make a Piña Colada with fruit.", -- 
        GIANT_BLUEBERRY_GIN = "Making a joke by eating it is a sin!", -- 

        -- Pot Cooking

        DARK_RUINCOLATE = "I experimented and made it my way.", -- 
        WHITE_RUINCOLATE = "Kids go crazy for it.", -- 
        RUINCOLATE = "Sweet and lovely.", --
        RUIN_SCHOKAKOLA = "One bite will definitely wake you up.", --
        ...
        DESALINATOR =
        {
            EMPTY = "Should I fill it with seawater?", --
        ...
        BARREL =
        { 
            GENERIC = "I can always keep water fresh.", 
            BURNT = "Comment est-ce possible?!\n(How is this possible?!) ",
        },

        BREWERY =
        {
            EMPTY = "Just having some drinks to accompany a meal elevates the experience.", 
            BURNT = "My heart feels like it's burnt too!", --
            FERMENTING_LONG = "Fermentation naturally takes a while.", -- 
            FERMENTING_SHORT = "I should hurry and prepare a dish to pair with it.", -- 
            DONE = "Ah, it's ready!", -- 
        },


        CAMPKETTLE_ITEM = "It is faithful to its primary function of boiling water.", -- 
        CAMPKETTLE =
        {
            GENERIC = "Did all the water evaporate from it?", --
            BOILING_LONG = "I should make some food while it's working.", --
            BOILING_SHORT = "The water has become quite clean.", -- 
            DONE = "I should use this to make tea.", -- 
            STOP = "It's cold now.", -- 
        },

        CAMPDESALINATOR_ITEM = "It looks quite complicated.", -- 
        CAMPDESALINATOR = 
        {
            GENERIC = "It's completely empty.",
            BOILING_LONG = "I should make some food while it's working.", 
            BOILING_SHORT = "The water has become quite clean.", 
            DONE = "I should use this to make soup.", 
            STOP = "It's still seawater.", 
        },

        KETTLE =
        {
            EMPTY = "Even the kettle is empty, and my throat is parched.", -- 
            BURNT = "J'ai juste versé des larmes..\n(I'm just shedding tears...)", -- 
            BOILING_LONG = "I need to simmer it enough to bring out the flavor.", --
        ...
        PORTABLEKETTLE_ITEM =
        {
            GENERIC = "It allows me to feel the warmth of tea anytime, anywhere.", -- 
        ...
        DISTILLERS =
        {   
            EMPTY = "I'll treat you to a good liqueur!", -- 
            DISTILLTING_LONG = "Shall I go gather some ingredients for cocktails?", -- 
            DISTILLING_SHORT = "I should hurry and prepare a dish to pair with it.", -- 
            DONE = "Our assistant has prepared some spirits.", --
        },

        WELL_WATERPUMP = {
            HIGH_PRESSURE = "It seems to be high-quality groundwater.", -- 
            MIDDLE_PRESSURE = "Being able to draw fresh water anytime is a blessing.", 
            LOW_PRESSURE = "The pressure is too low!", 
            RECHARG_PRESSURE = "The pressure has completely run out!", 
        },

        WELL_SPRINKLER =
        { 
            LOWFUEL = "It seems to have run out of fuel.", 
