return {
    ACTIONFAIL =
    {
        GIVE =
        {
            WELL_NOTEMPTY = "Let's clear the existing bucket first.", -- 
            WELL_BUSY = "Have patience, the bucket is still in the well.", -- 
        }
    },
        ...
        ANNOUNCE_THIRST = "I wish I could join the banquet now.", --
        ...
        DESCRIBE =
        {
            ...
            SPICE_CAFFEINPEPPER = "A powder that adds battle excitement to my feast.", 
            ...
            TEA_TREE = "A fragrant shrub.", -- 
            DUG_TEA_TREE = "I hope it returns to the Earth goddess.", --
            TEA_SEED = "This young tree is wrapped in red cloth.", -- 
            TEA_SEED_COOKED = "The young tree has been cooked.", --
            TEA_SEED_SAPLING = "Grow strong, young tree!", -- 
            ...
            RUINCACAO_TREE = "A tree from the age of darkness.", -- 
            ...
            ADDITIVE_SEED = "It will elevate the quality of the feast spirits.",
            ADDITIVE_PETALS = "Gifts from Freya, it seems.", -- 
            ADDITIVE_NUT = "Young trees have gathered here.", -- 
            ADDITIVE_DAIRY = "Are we putting dairy in alcohol?", --
            ...
            FRUITJUICE = "I'll consume only the water of this drink.", 
            ...
            MOON_BLOSSOM_TEA = "Indeed, it contains Mani's blessings.", -- 

            CAFFEINBERRY_JUICE = "It's bitter, and my heart is racing.", -- 
            TOFFEE_LATTE = "It's sweet and nutty.", -- 
            ...
            COCONUT_JUICE = "It's filled with soft flesh.", -- 
            RAINBOW_SHAKE = "It contains Freya's blessing!", -- 
            QUARTZ_SHAKE = "I'll gladly drink this!", -- 
            ...
            APPLEPINE_JUICE = "It has crushed the tough scales to get the flesh.", 
            CITROYUZU_JUICE = "Is it asking me to drink its tart juice?", 
            ...
            LIMONSODA = "It's not a drink worthy of a warrior.",
            ...
            APPLEPINESODA = "Whether it's pinecones or fruit, it's not right.", -- 
            CITROYUZUSODA = "It's spring water with a tangy fruit flavor.", --
            STRAWBERRYSODA = "The warrior has a distaste for mineral water with red fruits.", --

            -- Collaboration Spirits

            AUROBOW = "It glimmers beautifully!", -- 
            ...
            MADHU_RUM = "Vikings did not drink such.", 
            BERRY_BRANDY = "This is the liquor of haughty nobles.", 
            AREUHI = "It's not as bad as I thought.", 

            -- Warly Exclusive Distillery Spirits

            BERRY_GIN = "It's a mild drink when consumed sparingly, but becomes a bad one if consumed excessively.",
            GLOWBERRY_GIN = "It's a drink blessed by Balder's.", 
            ABSINTHE = "It has a refreshing scent!", 
            TEA_LUMPY_VODKA = "The scent of tea leaves emanates from the liquor.",
            PETALS_BERRY_BRANDY = "Warriors have no time to enjoy the scent of flowers.",
            KAHLUA = "As a warrior, this drink is too sweet for me.", 
            NUT_CORN_WHISKEY = "The scent of nuts is prominent.", 
            RUINCACAO_CREAM_LIQUEUR = "Is this for children?", --
            RUMCHATA = "I prefer to drink alcohol and milk separately.", -- 

            -- Collaboration Distillery Spirits

            MOONWAY = "It's the essence of light!", --
            ARRACK = "I can sense the scenery of palm trees.", -- 
            CHERRY_BLOOM_RUM = "It captures the essence of grandeur.", 
            RICE_SPIRITS = "It's clear and refreshing!",
            WHEAT_WHISKEY = "It's sweet and aromatic.", 
            PALE_WHISKEY = "It has a rough and bitter scent.",
            ...
            DESALINATOR =
            {
                ...
                PURIFY_LONG = "It's better to do something else while waiting.", --
                PURIFY_SHORT = "It's quite refreshing now.", -- 
                HASWATER = "It's full of spring water.", --
                BURNT = "It has been swallowed by flames.", -- 
                HASSALT = "There's too much mineral in it.", -- 
            },

            BARREL =
            {
                GENERIC = "It will hold my water.", -- 
                BURNT = "It couldn't escape Logi's touch.", -- 
            },
            ...
            {
                GENERIC = "It's empty.", -- 
                BOILING_LONG = "Let's be patient; it's not boiling yet.", --=
                BOILING_SHORT = "It won't take long.", --=
                DONE = "Now it's ready to drink.", -- =
                STOP = "You need to light the firewood first.", -- =
            },

            CAMPDESALINATOR_ITEM = "It's a pot that converts seawater into spring water.", -- 
            CAMPDESALINATOR =
            {
                GENERIC = "The pot seems to be in a drought.", -- 
                BOILING_LONG = "The seawater turns into clouds.", -- 
                BOILING_SHORT = "It's raining inside the pot!", -- 
                DONE = "It's full of spring water.", -- 
                STOP = "You need to light the firewood first.", -- 
            },

            KETTLE =
            {
                EMPTY = "It won't make a meat stew.", 
                BURNT = "It has been swallowed by flames.", -- 
                BOILING_LONG = "Let's not wait and do something else.", 
                BOILING_SHORT = "Tea is almost ready.", -- 
                DONE = "The tea is ready.", -- 
            ...
            WELL_WATERPUMP = {
                HIGH_PRESSURE = "Its power is comparable to that of giants.", 
                MIDDLE_PRESSURE = "The machine is working hard.", 
                LOW_PRESSURE = "The machine lacks power.",
                RECHARG_PRESSURE = "The machine is resting.", 
            },

            WELL_SPRINKLER =
            {
                LOWFUEL = "Fuel is running out.", 
                ON = "This rain comes from underground.", 
                OFF = "Have you found a place to sprinkle the rain?", 
            },
        },
    }