return {
    ...
    ANNOUNCE_CURE_WATERBORNE = "Even though this pain subsides, more pain will surely come.",

    ANNOUNCE_DCAPACITY_CRITICAL = "I may forget the embarrassment, but Abigail won't.",
    ANNOUNCE_DCAPACITY_HALF = "Now I understand why I was so embarrassed.",
    ...
    DESCRIBE =
    {
        ...
        WX78MODULE_NONEDRUNK = "It looks so fragile... hopefully no tragic accidents befall it.", 
        ...
        RUINCACAO_TREE = "It burned its seeds and turned them into nutrients.",
        DUG_RUINCACAO_TREE = "Was that cave your hell?",
        RUINCACAO_SEED = "I rescued it before it could burn.",
        RUINCACAO_SEED_SAPLING = "Life has sprung forth from the darkness.",
        RUINCACAO = "A makeup jar with tiny lives trapped inside.",
        RUINCACAO_BEAN = "It's filled with oil.",
        RUINCACAO_BEAN_COOKED = "In the end, it's all the same.",
        ...
        DRAGONJUICE = "Well, now it's juice.",
        GLOWBERRYJUICE = "Will my body glow blue?",
        WATERMELON_JUICE = "It's as watery as water itself.",
        ...
        RUINCOLATE_SMOOTHIE = "A whirlpool of sweetness.", 
        ...
        SPOILED_DRINK = "Can it get any worse than this?",
        ...
        DISINFECTANT = "It only turns wounds into wastelands by burning them hot.",
        CORN_WHISKEY = "It's just a poison that slowly kills people.",
        LUMPY_VODKA = "It will burn my throat.",
        TEQUILA = "Rough and toxic.",
        MADHU_RUM = "It will slowly drown itself without even knowing.",
        BERRY_BRANDY = "It will make you forget even the act of wanting to forget.",
        AREUHI = "Even without lactose, it must be painful.",

        -- Exclusive Distilled Spirits for Warly

        BERRY_GIN = "I've never seen it used as medicine.",
        GLOWBERRY_GIN = "It seduces people with its blue light.",
        ABSINTHE = "A woman in green clothes disguised as a serpent.", -- Absinthe (The Chronicles of Narnia)
        TEA_LUMPY_VODKA = "It won't make you healthier.",
        ...
        BUCKET_STEEL_EMPTY =
        {
            EMPTY = "Strong but heartless.", 
            FULL = "Filled with rainwater.", 
            FULL_ICE = "It's frozen solid.", 
            DIRTY = "Filled with life-rich toxic water.",
            DIRTY_ICE = "Freezing won't make it clean.", 
        },

        BUCKET_WOODIE_EMPTY =
        {
            EMPTY = "A wooden chunk emptied by death.", 
            FULL = "Filled with rainwater.", 
            FULL_ICE = "It's frozen solid.", 
            DIRTY = "Filled with life-rich toxic water.",
            DIRTY_ICE = "Freezing won't make it clean.", 
        ...
        DESALINATOR =
        {
            EMPTY = "Only the sound of emptiness is heard.",
            PURIFY_LONG = "It's just started to filter the salt.",
        ...
        BARREL =
        {
            GENERIC = "I'll store my water in it.",
            BURNT = "My throat will soon burn too.",
        },
        ...
        KETTLE =
        {
            ...
            MELT_LONG = "It's still frozen.", 
            MELT_SHORT = "I need to boil it a bit more to melt it.", 
        },
        ...
        WELL_WATERPUMP = {
            HIGH_PRESSURE = "It's pumping vigorously.", 
            MIDDLE_PRESSURE = "It will expel water in response to movement.", 
            LOW_PRESSURE = "It seems there's an arrhythmia.", 
            RECHARG_PRESSURE = "The heart has stopped.",
        },
