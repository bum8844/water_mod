return {
	...
	DESCRIBE =
	{
		...
		CAFFEINBERRY_BEAN_COOKED = "프렌치프레스만 어디서 구해오면 되겠군.", --구운 커피콩
		...
		WATER_CLEAN = "깨끗한 물 한 모금도 귀한세상이군.", --깨끗한 물
		...
		ORANGE_JUICE = "여기 오기전에는 휴게실에 항상있던거 처다도 안봤는데 말일세.", -- 모어 푸드 팩 오랜지 주스
		...
		CORN_BEER = "글쎄.. 옥수수로만든 밑술아닌가?", -- 콘 맥주 (wash - 위스키를 만들기 전 밑술.)
