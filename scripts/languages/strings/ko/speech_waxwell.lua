return {
	...
	DESCRIBE =
	{
		...
		RUINCACAO_TREE = "흑마법에 영향을 받은게 틀림 없구먼.", --카카오 나무
		...
		WATER_CLEAN = "깨끗한 물 한 모금도 귀한 세상이군.", --깨끗한 물
		...
		SUSHIBISCUS = "혹시 내가 생각하는 그건가?", --연꽃차
		...
		RUINCHA_LATTE = "진짜 모카 커피가 뭔지는 알지도 못하겠지.", --모카 라떼(커피+초코)
		...
		BUTTERBEER = "내 영혼은 갈기 갈기 찢어져도 다시 붙지.", --해리포터 시리즈의 버터비어
		...
		PINEANANAS_JUICE = "이런 시큼한 과일 주스는 한번에 못 마시겠단 말이지.", -- 레기온 파인애플 주스
		ORANGE_JUICE = "여기 오기전에는 휴게실에 항상 있던거 처다도 안 봤는데 말일세.", -- 모어 푸드 팩 오랜지 주스
		...
		SODA = "나는 시도 할 생각조차 못했는데 말이지.", -- 탄산수 (대충 먼지로 탄산 만들 생각 따위 못했다는 예기)
		...
		CORN_BEER = "글쎄.. 옥수수로 만든 밑술 아닌가?", -- 콘 맥주 (wash - 위스키를 만들기 전 밑술.)
		MADHU = "바이킹 전통 방식으로 안 만들었길 바래.", --벌꿀주
		WINE = "산딸기로 만들었다 해도 감지 덕지 해야지.", --와인 (그냥 베리 양조)
		NOBLEWINE = "삶이 꽤나 윤택해 졌구먼, 허.", --노블 와인(구운 베리 양조)
		SPARKLINGWINE = "샴페인이 그립군.", --스파클링 와인
		GLOWBERRYWINE = "나가서 팔 수만 있다면 큰 돈을 벌겠구먼.", --글로우 베리 와인
		KUMIS = "야성적이로구먼.", -- 크므즈,산양유주
		LUMPY_WINE = "생각보다 깔끔하군.", --서주(감자 고구마등 뿌리 술)
		PULQUE = "내 입맛에는 맞지 않는다네.", --풀케(선인주)
		RUINCACAO_WINE = "밖에선 보기 힘든 와인이구먼.", -- 카카오 와인 

		-- 콜라보 소다

		CHERRY_DOCTOR_COLA = "진짜 의사가 이 자리에 없는건 좀 아쉽군.", --체리숲 닥터 페퍼(닥터 체리)
		PINEANANASSODA = "문명인에 더 가까워진듯한 기분이군.", -- 탄산 파인애플(오란씨)
		ORANGESODA = "탄산이 강한건 매한가지 구먼.", -- 탄산 오랜지(환타)
		STRAWBERRYSODA = "탄산이 강한건 매한가지 구먼.", -- 탄산 딸기(웰치스 딸기)

		--콜라보 양조주

		AUROBOW = "발상이 정말 해괴 망측 하군.", -- 난파선 오로보우,무지개 해파리주
		COCONUT_WINE = "게살을 안주 삼아야 겠군.", -- 난파선 코코넛 와인
		CHERRY_BLOOM_MADHU = "슈트에 묻어도 적어도 탁에 어려움을 겪진 않겠네.", -- 체리숲 벚꽃꿀주
		GIANT_BLUEBERRY_WINE = "교양인 처럼 행동하자고.", -- 비타협 붐!베리 와인(불 붙히면 폭발함)
		...
		DISINFECTANT = "절단 마술 해봤나? 이게 필요 할 걸세.", -- 소독약
		CORN_WHISKEY = "아, 드디어.", -- 콘 위스키
		LUMPY_VODKA = "슬프게도 이젠 내가 노동자 신세로군.", -- 보드카
		TEQUILA = "시골 공연 느낌 나는구먼.", -- 데킬라
		MADHU_RUM = "천박하군.", -- 럼주
		...
		BUCKET_STEEL_EMPTY = 
		{
			...
			FULL = "빗물이나 받아 먹는 신세라니.", -- 깨끗한 빗물이 참
		...
		BUCKET_EMPTY = 
		{
			EMPTY = "내 손이 더러워 지는 것 보단 낫지.", -- 빈 나무 양동이
			FULL = "빗물이나 받아 먹는 신세라니.", -- 깨끗한 빗물이 참
			FULL_ICE = "내가 저걸 꺼내야 하는건가?", --빗물이 얼어버림
			DIRTY = "추악해라.", --빗물이 더러워짐
			DIRTY_ICE = "처다보기도 싫군.", --더러운 빗물 얼어버림
		...
		BREWERY =
		{
			...
			DONE = "마실 만한게 나온 건지나 빌어야지.", --양조기에 음료가 들어있음
		},
		...
		CAMPKETTLE =
		{
			...
			DONE = "내가 연못 물이나 끓여 마시는 신세라니.", --깨끗한 물이 들음
		...
		{   
			...
			DONE = "이제 술 다운 술을 마셔 보겠군.", --증류기에 음료가 들어있음
		},

		WELL_WATERPUMP = {
			HIGH_PRESSURE = "이봐, 이거 좀 시끄럽지 않나?", -- 압력 최대
			MIDDLE_PRESSURE = "내 손으로 일하지 않아도 되는건 좋.", -- 압력이 중간
