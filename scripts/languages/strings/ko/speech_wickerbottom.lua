return {
	...
	DESCRIBE =
	{
		...
		ANANAS_JUICE = "브로멜린이 많아 입안이 헐수 있으니 적당히 마시자구나.", -- 레기온 파인애플 주스
		ORANGE_JUICE = "오렌지 주스구나, 주스의 스트레오 타입이라할수있지.", -- 모어 푸드 팩 오랜지 주스
		...
		ANANASSODA = "파인애플과즙이 들어간 탄산수구나.", -- 탄산 파인애플(오란씨)
		ORANGESODA = "오렌지과즙이 들어간 탄산수구나.", -- 탄산 오랜지(환타)
