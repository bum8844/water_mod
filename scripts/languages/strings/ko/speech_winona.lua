return {
	ACTIONFAIL =
	{
		GIVE =
		{
			WELL_NOTEMPTY = "그렇게 할거 였으면 설계 때부터 도르래를 하나 더 달았어야지.", -- 우물에 말라 빈 양동이 달려있는데 양동이 달려 함
			WELL_BUSY = "그만 둬, 우물이 막힐 뿐이야.", -- 우물에 물 든 양동이 달려있는데 달려 함
		}
	},
	...
	ANNOUNCE_DCAPACITY_HALF = "음, 이제 좀 절제하는게 좋겠어.", -- 취기가 돌기 시작
	...
	DESCRIBE =
	{
		...
		GLOWBERRYJUICE = "굳이 말하자면 글로우스틱 안의 화합물 같다랄까.", -- 발광베리 쥬스
		...
		RUINCHA_LATTE = "커피와 초코, 둘 중에 하나를 선택하기 어렵다면야.", --모카 라떼(커피+초코)
		...
		PALE_BEER = "좀 마신다고 죽진 않겠지.", -- 레기온 페일에일 (몬스트라 열매를 쓴 청록색 맥주)
		...
		CHERRY_BLOOM_RUM = "공항 기념품 같아보이네.", -- 체리 꿀주 증류주 벛꽃잎 떠다
		...
		BUCKET_STEEL_EMPTY = 
		{
			...
			DIRTY_ICE = "한겨울에 청소하고 방치했나보군.", --더러운 빗물이 얼어버림
		},
		...
		BUCKET_WOODIE_EMPTY = 
		{
			...
			FULL_ICE = "빼려면 고생해야 겠는데?", --빗물이 얼어버림
			DIRTY = "걸레라도 한번 빤 물 같군.", --빗물이 더러워짐
			DIRTY_ICE = "한겨울에 청소하고 방치했나보군.", --더러운 빗물 얼어버림
		},
		...
		BUCKET_DRIFTWOOD_EMPTY = 
		{
			...
			FULL = "빗물이 고였네.", -- 깨끗한 빗물이 참
			FULL_ICE = "빼려면 고생 좀 해야겠는데?", --빗물이 얼어버림
			DIRTY = "걸레라도 한번 빤 물 같군.", --빗물이 더러워짐
			DIRTY_ICE = "한겨울에 청소하고 방치했나보군.", --더러운 빗물 얼어버림
		},
