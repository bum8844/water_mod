return {
	...
	DESCRIBE =
	{
		...
		RUINCACAO_BEAN = "타는 냄새 나는것 같지 않아?", --부순 후 카카오 콩  
		...
		POMEGRANATE_JUICE = "음료수가 된 걸 마셔도 지하에 머물러야 할까?", -- 석류 쥬스
		BANANA_JUICE = "필멸자들이 좋아할 음료수야.", -- 바나나 쥬스
		FIG_JUICE =  "마시면 동산애서 쫒겨날 거야.", -- 무화과 쥬스
        ...
        TOFFEE_LATTE = "난 음료랑도 잘 안 맞아.", --토피넛 라떼
		RUINCHA_LATTE = "이건 마셔볼 필요는 있겠네.", --모카 라떼(커피+초코)
		
		HOTRUINCOLATE = "털 없는 필멸자들의 겨울 대비책이야.", --핫초코
		RUINCOLATE_SMOOTHIE = "찬 거 좋지. 마시는 건 별로지만.", --초코 스무디(차가움)
		RUINXOCOLATL = "반만 느껴져도 쓰잖아!", --쇼콜라틀(매캐함)
		TEA_RUINCOLATE_LATTE = "난 마시는 거 별로 안 좋아해.", -- 말차 라떼
		...
		QUARTZ_SHAKE = "물고기도 마셔지리라곤 상상도 못 했을걸.", --난파선 광대 물고기 쉐이크
		CHERRY_ROSEBERRIES_TEA = "그림자 느낌 나는 장미향이네.", --체리숲 로즈힙 차
		CHERRY_HONEY_TEA = "이렇게 달면 먹을 만 하지.", --체리숲 벚꽃꿀 차
		SWEET_RICE_DRINK = "마시는 거랑 먹는 걸 같이 해야 한다니!", -- 비타협 식혜
		PINEANANAS_JUICE = "난 영혼이면 될 것 같아.", -- 레기온 파인애플 주스
		ORANGE_JUICE = "난 주황색 보는 걸로 만족할게.", -- 모어 푸드 팩 오랜지 주스
		STRAWBERRY_SMOOTHIE = "갈린 붉은 과실이야.", -- 모어 푸드 팩 딸기 스무디
		STRAWBERRY_MILK_SMOOTHIE = "적어도 부드러운 게 좋겠지.", -- 모어 푸드 팩 딸기 스무디 라떼
		...
		LEMONLIMESODA = "과일 맛 나는 단물이네.", -- 레몬 라임소다(과일소다 상위 호환)
		COLA = "검은 것 치곤 먹을만 한 걸!", -- 콜라
		COLAQUANTUM = "흐유유! 방사능 좋지!", --콜라 퀀텀
		LUMPY_BEER = "경찰에 적성에 맞게 생겼네.", --루트비어(술이 아님)
		...
		NOBLEWINE = "어떻게 붉은색이 흰 색이 될 수 있는걸까?", --노블 와인(구운 베리 양조)
		SPARKLINGWINE = "흐유유, 몸에 나쁜 것 투성이네!", --스파클링 와인
		GLOWBERRYWINE = "참 특이한 것도 마시려 드네.", --글로우 베리 와인
		KUMIS = "뭐, 쿠키 옆에 두긴 별로네.", -- 크므즈,산양유주
		LUMPY_WINE = "지하세계 출신은 믿을 게 못 되지.", --서주(감자 고구마등 뿌리 술)
		PULQUE = "가시 돋친 식물을 마실 생각은 누가 한 걸까?", --풀케(선인주)
		...
		COCONUT_WINE = "별 맛 안나.", -- 난파선 코코넛 와인
		CHERRY_BLOOM_MADHU = "이렇게 단 술이면 마실 만 하지.", -- 체리숲 벚꽃꿀주
		GIANT_BLUEBERRY_WINE = "마실 만 하지. 무기로는 더 좋고!", -- 붐 베리 와인 (불 붙히면 폭발함)
		...
		DISINFECTANT = "영혼만 있으면 소독 안 해도 돼.", -- 소독약
		...
		BERRY_GIN = "필멸자들이 다른 거랑 섞어서 마시더라고.", --진
		GLOWBERRY_GIN = "배가 빛나겠는데.", --글로우 베리 진
		ABSINTHE = "색만 빼면 나랑 비슷할지도 몰라.", -- 압생트
		...
		CHERRY_BLOOM_RUM = "이건 마실 만 해.", -- 체리 꿀주 증류주 벛꽃잎 떠다
		RICE_SPIRITS = "물 사이에 숨겨 놓으면 재밌겠는데.", --청주
		WHEAT_WHISKEY = "필멸자들 음료수에 섞어 놔야지. 흐유유.", -- 밀 위스크
		PALE_WHISKEY = "정말 창백해.", -- 페일 몰트 위스키

		--왈리 전용 콜라보 증류주

		NUT_COCONUT_BRANDY = "어이, 문어 머리! 찾는 거 있어? 혹시 이거 아닌가? 멀쩡해!", -- Oi, fishface! Lose something? Eh? Got it!. -- 캐리버인아의 해적, 잭 스패로우
        ...
        RUINCOLATE = "대부분 좋아하는 블럭이야.", -- 그냥 초콜릿
        RUIN_SCHOKAKOLA = "필멸자들은 처음 보는 식물도 먹으려 드는건가?", -- 쇼카콜라
		...
		BUCKET_STEEL_EMPTY = 
		{
			...
			DIRTY_ICE = "정말 세상 풍파 다 겪었어.", --더러운 빗물이 얼어버림
		},
		...
		WELL_WATERPUMP = {
			...
			RECHARG_PRESSURE = "충전 좀 다시 해야겠어!", -- 압력이 아예 없을때(여기까지 쓰면 압력이 최대가 될때까지 못씀.)
		},
