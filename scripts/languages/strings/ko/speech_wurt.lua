return {
	...
	DESCRIBE =
	{
		...
		WELL_BURYING_KIT = "땅에뚫은 구멍 막아!", -- 구멍 매설 키트
		...
		RUINCACAO_TREE = "검은과일 그냥먹음 맛 업써.", --카카오 나무
		...
		ADDITIVE_DAIRY = "우리집 흙같은데 하얘!", -- 리큐르에 제조에 첨가할 유제품 첨가제
		...
		SWEET_RICE_DRINK = "어인들 물간식 술 안만들어.", -- 비타협 식혜
		PINEANANAS_JUICE = "시큼한과일 물에 넣어 덜시고 더 달아, 뽀륵.", -- 레기온 파인애플 주스
		...
		RICE_WINE = "물간식 술 됬어...", -- 비타협 막걸리
		WHEAT_BEER = "거품머리 하고있어, 뽀륵.", -- 힙 오브 푸드 밀맥주
		PALE_BEER = "늪지대열매 술 만든거 처음봐.", -- 레기온 페일에일 (몬스트라 열매를 쓴 청록색 맥주)
		...
		NUT_CORN_WHISKEY = "간식들 술말고 나 줬으면 좋겠어, 뽀륵.", -- 너트 위스키
