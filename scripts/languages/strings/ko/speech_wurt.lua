return {
    ...
    ANNOUNCE_CAFFINE_BUFF_STOP = "더 이상 뛸 기분 아니야." ,  -- 카페인 버프 끝
	...
	DESCRIBE =
	{
		...
		WELL_WATERPUMP_KIT = "만들기 어려워 보여..", --스팀 물펌프 키트
		WELL_BURYING_KIT = "땅에 뚫은 구멍 막아!", -- 구멍 매설 키트
		WELL_DRILLING = "땅에 구멍 내고 이써, 뽀륵.", --드릴로 구멍 뚫는 중
		...
		DUG_TEA_TREE = "너, 나랑 가자, 뽀륵.", --땅에서 파낸 차나무
		...
		DUG_CAFFEINBERRY = "너 좋은 곳 찾을 거야.", --파낸 커피덤불
		CAFFEINBERRY_BEAN = "맛있는 간식이야!", --생 커피콩
		CAFFEINBERRY_BEAN_COOKED = "더 이상 맛있지 않아..", --구운 커피콩

		RUINCACAO_TREE = "검은 과일 그냥 먹음 맛업써.", --카카오 나무
		DUG_RUINCACAO_TREE = "너 좋은 곳 찾을 거야.", --파낸 카카오 나무
		RUINCACAO_SEED = "으스스해, 뽀륵.", --카카오 새싹 아이템
		RUINCACAO_SEED_SAPLING = "아직 과일 만들기엔 너무 작아.", -- 카카오 새싹 심은거
		RUINCACAO = "아야! 너무 딱딱해!", --부수기 전 카카오 열매
		RUINCACAO_BEAN = "기름 많아, 뽀륵.", --부순 후 카카오 콩  
		RUINCACAO_BEAN_COOKED = "아직 초콜릿 아니야!", --구운 카카오 콩

		-- 증류주 첨가제

		ADDITIVE_SEED = "흙에 안 넣어? 뽀륵.", -- 리큐르에 제조에 첨가 할 씨허브(아니스,쥬니퍼베리,팔각 모티브)첨가제 
		ADDITIVE_PETALS = "이파리 모아 놔써.", -- 리큐르에 제조에 첨가 할 허브,녹차,꽃잎 첨가제
		ADDITIVE_NUT = "간식 안 먹어?", -- 리큐르에 제조에 첨가 할 버치넛,코코넛,커피콩,카카오콩 첨가제
		ADDITIVE_DAIRY = "우리집 흙 같은데 하얘!", -- 리큐르에 제조에 첨가할 유제품 첨가제

		-- 음료

		WATER_CLEAN = "물에서 아무 냄새 안나!", --깨끗한 물
		WATER_DIRTY = "우리 집 연못 물이야!", --더러운 물
		WATER_SALTY = "큰 연못 물이야!", --바닷물

		GOOPYDRINK = "우리 집 연못 물이야?", --실패한 음료(웻 굽 개념)
		
		-- 주전자 음료

		FRUITJUICE = "과일 여러가지 맛이야!", --잡 과일쥬스
		BERRIES_JUICE = "덤불 과일 주스!", -- 베리 쥬스
		POMEGRANATE_JUICE = "빨간 과일 알맹이 잔뜩 씹혀, 뽀륵!", -- 석류 쥬스
		BANANA_JUICE = "따뜻해도 과일 주스 맛있어!", -- 바나나 쥬스
		FIG_JUICE = "으으음, 쫄깃 쫄깃 꿀꺽 꿀꺽", -- 무화과 쥬스
		...
		BLACKTEA = "뜨거운 물 향기로워!", --홍차
		BLACKTEA_ICED = "차가운 물 향기로워!", -- 홍차 아이스티
		FUER = "동굴 식물 빨간색 됬어, 뽀륵!", --보이차,이파리차,고사리차
		MIXFLOWER = "못생긴 꽃 들어갔어!", --잡 꽃잎 차
		HIBISCUSTEA = "히히, 빨간 꽃 삶았어.", --히비스커스 차
		CACTUSFLOWER_TEA = "못생긴 꽃 들어가서 달어, 뽀륵!", --선인꽃차
		LOTUSTEA = "매끈이들은 이 꽃 물 예쁘데, 난 모르겠어, 뽀륵.", --연꽃차
		SUSHIBISCUS = "물에 엄청 못생긴 꽃 들어가 있어.", -- 자살차
		...
		TEA_RUINCOLATE_LATTE = "풀 냄새 나고 마시써!", -- 말차 라떼

		MULLED = "으으음, 따끈하고 나른해져!", --뱅쇼
		BUTTERBEER = "벌레 맛 안나고 엄청 달아!", --해리포터 시리즈의 버터비어
		...
		CHERRY_ROSEBERRIES_TEA = "못생긴 열매 머리카락 없지?", --체리숲 로즈힙 차
		CHERRY_HONEY_TEA = "예쁜 벌꿀 꿀 탄 물 마시면 몸 따듯해져!", --체리숲 벚꽃꿀 차
		SWEET_RICE_DRINK = "어인들 물 간식 술 안 만들어.", -- 비타협 식혜
		PINEANANAS_JUICE = "시큼한 과일 물에 넣어 덜 시고 더 달아, 뽀륵.", -- 레기온 파인애플 주스
		ORANGE_JUICE = "과즙 팡팡 상큼해, 뽀륵!", -- 모어 푸드 팩 오랜지 주스
		STRAWBERRY_SMOOTHIE = "흐드드, 빨간 과즙 얼은거 갈았어!", -- 모어 푸드 팩 딸기 스무디
		...
		SODA = "물 이상해, 톡 톡 하고 있어.", -- 탄산수
		FRUITSODA = "과즙 맛 나는데 톡 톡이 방해해.", -- 과일소다
		LEMONLIMESODA = "달고 맛있는데 이상해!", -- 레몬 라임소다(과일소다 상위 호환)
		COLA = "이거 엄청 맛 나, 굉장해 뽀륵!", -- 콜라
		COLAQUANTUM = "반짝반짝 하고 소리 나, 뽀륵!", --콜라 퀀텀
		LUMPY_BEER = "약 맛 나는데 달고 톡 톡 해.", --루트비어(술이 아님)

		-- 양조주

		CORN_BEER = "거품 머리 하고 있어, 뽀륵.", -- 콘 맥주
		MADHU = "바이킹 여자가 이거 엄청 찾아.", --벌꿀주
		WINE = "뽀르륵... 빨간데 이상해, 안 달아.", --와인 (그냥 베리 양조)
		NOBLEWINE = "덤불 간식 상해서 하얀 술, 만들어?", --노블 와인(구운 베리 양조)
		SPARKLINGWINE = "위커 아줌마가 흔들지 말랬어.", --스파클링 와인
		GLOWBERRYWINE = "빛나는 열매 술 말고 주스 줘.", --글로우 베리 와인
		KUMIS = "찌르르한 우유 상했어?", -- 크므즈,산양유주
		LUMPY_WINE = "이 흙 야채 물 머리 아픈 냄새 나.", --서주(감자 고구마등 뿌리 술)
		PULQUE = "가시 많은 식물 짜서 '바료' 시켰데!", --풀케(선인주)
		RUINCACAO_WINE = "검은 과일 더 이상한 맛 되었어.", -- 카카오 와인 

		-- 콜라보 소다

		CHERRY_DOCTOR_COLA = "검은 물 톡 톡 하고 붉은 과즙 맛 나!", --체리숲 닥터 페퍼(닥터 체리)
		PINEANANASSODA = "톡 톡 하는 시큼한 과일 물!", -- 탄산 파인애플(오란씨)
		ORANGESODA = "뽀륵, 상큼하고 시원해!", -- 탄산 오랜지(환타)
		STRAWBERRYSODA = "톡 톡 하는 붉은 과일 물이야, 뽀륵.", -- 탄산 딸기(웰치스 딸기)

		--콜라보 양조주

		AUROBOW = "예쁜 물고기... 어쨰서?", -- 난파선 오로보우,무지개 해파리주
		COCONUT_WINE = "술 에서 물 든 과일 물 냄새 나.", -- 난파선 코코넛 와인
		CHERRY_BLOOM_MADHU = "예쁜 벌꿀 꿀로 술 만들었어?", -- 체리숲 벚꽃꿀주
		GIANT_BLUEBERRY_WINE = "불 붙히면 터진데.", -- 비타협 붐!베리 사파이어(불 붙히면 폭발함)
		RICE_WINE = "물 간식 술 됬어...", -- 비타협 막걸리
		WHEAT_BEER = "거품 머리 하고 있어, 뽀륵.", -- 힙 오브 푸드 밀맥주
		PALE_BEER = "늪지대 열매 술 만든거 처음 봐.", -- 레기온 페일에일 (몬스트라 열매를 쓴 청록색 맥주)
		...
		TEQUILA = "술이 가시 많은 식물 성격 닮았어!", -- 데킬라
		MADHU_RUM = "매끈이들 배 탈때 물에 섞었데, 왜?", -- 럼주
		BERRY_BRANDY = "내 덤불 간식은 어딨어, 뽀륵?", -- 베리 브랜디
		AREUHI = "우유 어디 갔어?", -- 크므즈 증류주 아르히

		--왈리 전용 증류주

		BERRY_GIN = "이건 향이 더 독해, 뽀륵.", --진
		GLOWBERRY_GIN = "빛나는 열매 술 말고 주스 줘.", --글로우 베리 진
		...
		NUT_COCONUT_BRANDY = "물 든 과일 냄새 진한데 독해!", -- 코코넛 브랜디 (캐러비안 럼을 만들수 없어서 카리브 브랜디 라는 이름으로 대체)
	    GIANT_BLUEBERRY_GIN = "콰과광!", -- 붐 베리 사파이어 (당근 폭발함)

		--냄비 요리

        DARK_RUINCOLATE = "요리 하는 남자 간식 이상한거 줬어..", --다크 초콜릿.
        WHITE_RUINCOLATE = "얌! 얌!", --화이트 초콜릿
        RUINCOLATE = "씹으면 찐득 찐득 달콤해!", -- 그냥 초콜릿
        RUIN_SCHOKAKOLA = "맛있는데 너무 많이 먹으면 못 자!", -- 쇼카콜라
		...
		BUCKET_STEEL_EMPTY = 
		{
			...
			DIRTY_ICE = "흐드드, 작은 연못 얼었어.", --더러운 빗물이 얼어버림
		},

		BUCKET_WOODIE_EMPTY = 
		{
			EMPTY = "나무 베는 사람이 뒤집어서 앉지 말래.", --우디의 빈 나무 양동이
			FULL = "빗물 가득!",  --깨끗한 빗물이 참
			FULL_ICE = "흐드드, 만지기 싫어.", --빗물이 얼어버림
			DIRTY = "엄청 작은 연못 되었어, 뽀륵!", --빗물이 더러워짐
			DIRTY_ICE = "흐드드, 작은 연못 얼었어.", --더러운 빗물 얼어버림
		},
		...
		DESALINATOR =
		{
			EMPTY = "엄청 큰 연못 물 마실수 있게 만든대!", --제염기에 물이 없음
			PURIFY_LONG = "빙글 빙글 쪼로록!", -- 정수 끝나기까지 많이 남음
			PURIFY_SHORT = "곧 마실수 있는 물 되, 뽀륵!", -- 정수가 곧 끝남
			HASWATER = "물 이제 안 짜!", --제염기에 깨끗한 물이 있음
			BURNT = "나 아니야, 뽀륵!",   --제염기가 타버림
			HASSALT = "짠 돌 너무 많아서 소용없어, 뽀륵.", --제염기에 소금이 남아 있음
		},

		BARREL =
		{
			GENERIC = "위커 아줌마에 이거에 물고기 키우지 말라고 혼났어..", -- 물통 조사 대사
		...
		CAMPKETTLE_ITEM = "매끈이들 연못 물 마시러면 필요해!", --휴대 주전자 아이템 조사 대사
		CAMPKETTLE =
		{
			GENERIC = "에이, 텅 비었네.", -- 화덕에 건 휴대 주전자 안에 물이 없음
			BOILING_LONG = "물 아직 차가워, 뽀륵.", -- 물 끓이기 시작함
			BOILING_SHORT = "뜨거워!!", -- 물 거의 다 끓음
			DONE = "물 에 냄새 안나?", --깨끗한 물이 들음
			STOP = "연못 물 들어 있어.", --화덕에 불이 없어서 더러운물이 끓지 않는 상태
		},
		...
		CAMPDESALINATOR = 
		{
			...
			STOP = "큰 연못 물 들어 있어, 뽀륵.", -- 화덕에 불이 없어서 소금물이 정수 되지 않는 상태
		},
		...
		KETTLE =
		{
			...
			PURIFY_LONG = "연못물 안 끓이면 음료 맛이 나쁘데.", -- 더러운 물을 끓이기 시작한지 얼마 안됨
			PURIFY_SHORT = "냄새가 거의 없어진것 같아, 뽀륵!", --더러운물을 거의 다 끓여감
			HASWATER = "음식도 넣어야 해, 뽀륵.", -- 깨끗한 물이 차 있는 상태
		...
		PORTABLEKETTLE_ITEM =
		{
			GENERIC = "물맛 더 좋게 한데!", -- 휴대용 주전자(아이템) 조사 대사
			EMPTY = "물 이랑, 음식 피료해!", -- 설치한 빈 휴대용 주전자 조사 대사
			BOILING_LONG = "이거 너무 오래 걸려!", -- 음료를 만들기 시작한지 얼마 안됨
		...
		DISTILLERS =
		{   
		    EMPTY = "예쁜 돌로 만든 가마솥!", --증류기 조사 대사
			DISTILLTING_LONG = "위에 보고 있으면 누니 핑 핑 돌아.", --증류가 끝나기 까지 많이 남음
			DISTILLING_SHORT = "나는 술 안 마셔, 뽀륵.", --증류가 곧 끝남
			DONE = "마실수 있는 사람 주자, 뽀륵!", --증류기에 음료가 들어있음
		},
		...
		WELL_SPRINKLER =
		{ 
			LOWFUEL = "연료 넣으면 물 더 뿌릴수 있어, 뽀륵.", -- 연료가 거의 없는 상태에서의 조사 대사
			ON = "물 계속 뿌리면 늪지 될지도 몰라, 뽀륵!", -- 작동중임
