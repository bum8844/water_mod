return {
	ACTIONFAIL =
	{
		GIVE =
		{
			WELL_NOTEMPTY = "물동이부터 꺼내야겠군.", -- 우물에 말라 빈 양동이 달려있는데 양동이 달려 함
	...
	DESCRIBE =
	{
		...
		WELL_DRILLING_ITEM = "일종의 농기계인가? 아니, 조금 다르군.", --드릴 아이템
		...
		TEA_SEED_COOKED = "삶아 죽였어.", --구운 차나무 열매
