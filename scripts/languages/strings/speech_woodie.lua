return {
	...
	DESCRIBE =
	{
		...
		PURIFICATION_TABLETS = "물 좀 나무 베듯 정화해 봐야겠어.", -- 정화제
		...
		MENTHA_SPICATA_TEA = "박하 향이 나무 냄새랑 잘 어울리네!", -- 박하차
		...
		SPARKLINGWINE = "흔들어서 낭비하는녀석은 나와 루시가 가만 안둬야겠어.", --스파클링 와인
		...
		AUROBOW = "살다살다 해파리로 만든 술을 보네.", -- 난파선 오로보우,무지개 해파리주
		...
		WHEAT_WHISKEY = "손님이 오면 커피를드릴지 위스키를드릴지 물어봐야지.", -- 밀 위스키
