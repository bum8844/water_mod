return {
    ...
    ANNOUNCE_NOTCHARGE = "Nó trông có vẻ không có sữa dành cho tui để chia sẻ.", -- Lightning dê không sạc được nên không thể vắt sữa vào xô
    ...
    ANNOUNCE_SLEEP_END = "Vẫn mắc kẹt trong ác mộng, tôi tưởng nó kết thúc rồi chứ.", -- Tỉnh dậy sau khi ngủ và hoàn toàn tỉnh táo
    ANNOUNCE_THIRST = "Cổ họng tui khô khốc.", -- Khát nước
    ...
    ANNOUNCE_DCAPACITY_HALF = "Bây giờ tôi đã hiểu tại sao tôi lại xấu hổ đến thế.", -- Cảnh báo nửa tỉnh táo
        ...
        DESCRIBE =
        {
            BOILBOOK = "Ngay cả khi tôi có thể làm dịu cơn khát của chính mình, nó cũng chỉ trôi đi trong nước mắt.",
            ...
            WELL_KIT = "Thật nặng nề nhưng tôi sẽ cố gắng duy trì động lực.",
            WELL_SPRINKLER_KIT = "Nếu tôi chỉ định nơi cài đặt máy, nó sẽ tự động tìm vị trí của nó.",
            WELL_WATERPUMP_KIT = "Trái tim máy móc lạnh lùng.",
            WELL_BURYING_KIT = "Ngay cả khi bạn đào một cái hố sâu như vậy và cố gắng bịt kín nó bằng một chiếc đinh khổng lồ..",
            WELL_DRILLING = "Khoan một lỗ lớn vào lòng đất.",
            WELL_DRILLING_ITEM = "Nó sẽ khoan một lỗ sâu vào lòng đất.",
            HOLE = "Tôi còn chưa chạm tới đáy, làm sao tôi có thể về nhà?\n Alice’s Adventures in Wonderland", --(Alice’s Adventures in Wonderland)
            ...
            TEA_SEED = "Sự sống đã tìm được chỗ đứng trong cái chết bất ổn.", -- Tea Tree Seed
            TEA_SEED_COOKED = "Nó đã bị nướng chết.", -- Hạt giống cây trà đã nấu chín
            TEA_SEED_SAPLING = "Chúng được chia rẽ từ cùng một gốc nhưng chúng không bao giờ bị cô đơn.", -- Cây non cây trà
            TEALEAVES = "Những chiếc lá sẽ không bao giờ tự gắn vào thân cây nữa.", -- Lá trà
            TEALEAVES_DRIED = "TNhững chiếc lá của anh ta bị cháy sém bởi ánh nắng mặt trời.", -- Lá trà khô

            CAFFEINBERRY = "Cây tạo ra hạt đậu.", -- Caffeine Bush
            DUG_CAFFEINBERRY = "Ôi buồn kinh, ngươi không có nhà.", -- Đào lên Caffeine Bush
            ...
            ADDITIVE_SEED = "Nó thu thập những hạt có mùi thơm khác thường.", -- Phụ gia rượu mùi (Hồi, Juniperberry, Parrot Motif)
            ...
            ADDITIVE_DAIRY = "Nó bịt kín kem.", -- Phụ gia rượu mùi (sữa)

            -- Đồ uống

            WATER_CLEAN = "Nó kéo dài tuổi thọ trong giây lát.", -- Nước sạch
            WATER_DIRTY = "Nếu bạn muốn trải nghiệm một nỗi đau lâu dài.", -- Dirty Water
            WATER_SALTY = "Nó mang lại sự sống nhưng cũng là chất độc dẫn đến cái chết..\nSalt Water from the novel \"Lord of the Flies\"", -- Nước Muối (từ tiểu thuyết "Chúa Ruồi")

            GOOPYDRINK = "Giống như cuộc sống của tôi, thứ này thật hỗn loạn.", -- Đồ uống thất bại (Rang Ướt)

            -- Đồ uống ấm trà

            FRUITJUICE = "Được làm từ nhiều loại trái cây.", -- Nước ép trái cây hỗn hợp
            BERRIES_JUICE = "Nó có lẽ phải nhét rất nhiều quả mọng để chứa đầy cái lọ đấy.", -- Berry Juice
            ...
            CACTUS_TEA = "Tất cả là do ta đã cho quá nhiều nước khiến nó bị đuối.", -- Trà xương rồng
            TOMATO_JUICE = "Máu sẽ đặc hơn nhưng thứ tôi cần là nước.\nfrom a Place of Love", -- Tomato Juice
            LUMPY_TEA = "Nó sẽ không thể bám rễ lâu hơn nữa.", -- Trà rễ
            SEAWEED_SHAKE = "Tôi chả biết nói gì với cái thứ này.", -- Seaweed Shake

            GREENTEA = "Không biết có thể gọi loại trà này là trà không.", -- Trà xanh lá tươi
            BLACKTEA = "Một phút nghỉ ngơi ngắn ngủi cho những tâm hồn mệt mỏi...", -- Trà đen (Jane Austen / Kiêu hãnh và định kiến)
            BLACKTEA_ICED = "Một khoảng nghỉ ngắn cho tâm hồn mệt mỏi...", -- Trà đen đá
            FUER = "Tôi không thể gặp Người làm mũ để chúc mừng sinh nhật hôm nay.\nAlice's Adventures in Wonderland", -- Fuertea, Trà lá, Trà dương xỉ (Cuộc phiêu lưu của Alice ở xứ sở thần tiên)
            MIXFLOWER = "Tôi đã hái những cánh hoa và luộc chúng.", -- Trà cánh hoa hỗn hợp
            HIBISCUSTEA = "Nó khá thơm.", -- Trà dâm bụt
            CACTUSFLOWER_TEA = "Ngay cả khi đun sôi, nó trông vẫn đẹp. Tôi ghen tị.", -- Trà hoa xương rồng
            LOTUSTEA = "Sự bình tĩnh đã bén rễ ngay cả trong đau khổ.", -- Trà Sen
            SUSHIBISCUS = "Giá như tôi có thể ở bên Abigail dù chỉ một lát.", -- Suicide Tea
            MOON_BLOSSOM_TEA = "Nó không thể toát lên vẻ đẹp nào nữa.", -- Trà hoa trăng

            CAFFEINBERRY_JUICE = "Đậm và đắng.", -- Cà phê đen
            TOFFEE_LATTE = "Nó quá ngọt, thiếu đi dư vị dai dẳng của hương cà phê.", -- Toffeenut Latte
            ...
            MULLED = "Nó có thể làm tan chảy một trái tim lạnh giá và tan vỡ không?", -- Bancha (Mulled)
            BUTTERBEER = "Ngọt ngào như ma thuật.", -- Butterbeer (loạt phim Harry Potter)

            -- Đồ uống ấm trà hợp tác

            COCONUT_JUICE = "Tôi ước gì tôi có thể rèn luyện nội tâm của mình như thế này.", -- Shipwrecked Coconut Juice
            ...
            PINEANANAS_JUICE = "Nó xé nát lớp vỏ cứng và nghiền nát cùi.", -- Nước Dứa Legacy
            ...
            MADHU = "Phải đánh cắp bao nhiêu mật ong để làm được thứ này?", -- Bee's Honey Wine
            WINE = "Đỏ và sẫm như máu.", -- Rượu (Berry Brewing)
            NOBLEWINE = "Có phải nó được làm từ trái cây bị bệnh bạch cầu?", -- Noble Wine (Baked Berry Brewing)
            SPARKLINGWINE = "Nó ngăn chặn nó bên trong bằng một nút chai nhỏ.", -- Sparkling Wine
            GLOWBERRYWINE = "Có một con ma lung linh bị mắc kẹt bên trong cái chai?", -- Glow Berry Wine
            KUMIS = "Thật là một điều đáng buồn cho các em bé.", -- Kumis, Sữa ngựa lên men
            ...
            RUINCACAO_WINE = "Bây giờ nó sẽ không bao giờ trở nên ngọt ngào nữa.", -- Cacao Wine

            -- Soda hợp tác

            CHERRY_DOCTOR_COLA = "Đó không phải là một bác sĩ thực sự, nhưng nó có thể mang lại sự thoải mái thoáng qua.", ---★★★★★
            PINEANANASSODA = "Đó là soda thơm và ngọt.",
            ...
            AUROBOW = "Ngay cả khi được làm thành rượu, nó vẫn tỏa sáng với màu sắc rực rỡ.", -- Aurobou bị đắm tàu, Rượu thạch cầu vồng
            COCONUT_WINE = "Một mùi hương ngọt ngào thoang thoảng thoang thoảng.", -- Rượu dừa đắm tàu
            ...
            RICE_WINE = "Đó là rượu làm từ gạo.", -- Vita-Hybiscus Makgeolli
            ...
            ABSINTHE = "Một người phụ nữ mặc quần áo màu xanh lá cây cải trang thành một con rắn.\n Absinthe (The Chronicles of Narnia)", -- Absinthe (Biên niên sử Narnia)
            ...
            RUINCACAO_CREAM_LIQUEUR = "Chỉ có mùi thơm là ngọt ngào.", -- Rượu mùi kem Cacao Baileys
            RUMCHATA = "Đưa thức uống này cho những đứa trẻ đang đau khổ.", -- Rumchata (Hỗn hợp rượu Rum và Horchata)
            ...
            RICE_SPIRITS = "Đó là rượu mạnh đội lốt nước.", -- Makgeolli
            ...
            NUT_COCONUT_BRANDY = "Cùng một câu chuyện, với những phiên bản khác nhau, và tất cả đều có thật.\nPirates of the Caribbean : Tia Dalma",  --★★★★★ (Pirates of the Caribbean : Tia Dalma)
            GIANT_BLUEBERRY_GIN = "Tôi cũng đang tự hủy hoại bản thân mình.",  
            ...
            RUINCOLATE = "Đó là nhiên liệu đen ăn được.", 
            RUIN_SCHOKAKOLA = "Có mọi thứ để đánh thức bạn dậy.", 
            ...
            DESALINATOR =
            {
                ...
                HASSALT = "Giống như lọc muối bằng muối vậy.", -- Còn muối trong máy khử muối
            },
            ...
            BREWERY =
            {
                EMPTY = "Chỉ cần thối các thành phần để làm cho chúng có thể uống được.", 
                BURNT = "Chỉ còn lại mùi cháy khét.", 
                FERMENTING_LONG = "Dù có gì bên trong thì nó vẫn còn tươi nguyên.", 
            ...
            CAMPKETTLE_ITEM = "Đó là một chiếc ấm đun nước có tay cầm.", -- Kiểm tra vật phẩm ấm đun nước cắm trại
            CAMPKETTLE =
            {
                GENERIC = "Tôi có thể múc nước từ ao bằng nó.", -- Ấm đun nước di động rỗng trên hố lửa
            ...
            CAMPDESALINATOR =
            {
                GENERIC = "Tôi có thể lấy một ít nước biển với nó.", -- Không có nước trong máy khử muối
                BOILING_LONG = "Hầu hết là nước biển.", -- Nó bắt đầu sôi
                BOILING_SHORT = "Nhiều sinh mạng chắc chắn đã bị mất.", -- Nó gần như đã sôi
                DONE = "Tôi đã kéo dài tuổi thọ của nó thêm một chút.", -- Thu được nước sạch
            ...
            KETTLE =
            {
                ...
                BOILING_LONG = "Dù có gì bên trong thì nó vẫn còn sống.", -- Nó mới bắt đầu pha đồ uống
                BOILING_SHORT = "Cần thêm chút thời gian để nấu.", -- Gần như đã nấu xong đồ uống
                DONE = "Cuối cùng tôi cũng có thể làm dịu cơn khát của mình.", -- Đồ uống đã sẵn sàng
            ...
            DISTILLERS =
            {
                EMPTY = "Máy móc sẽ uống rượu và cuối cùng rượu sẽ tiêu thụ con người.", -- Kiểm tra máy chưng cất
            ...
            WELL_SPRINKLER =
            {
                LOWFUEL = "Nó có thể hoạt động trở lại miễn là tôi cung cấp nhiên liệu.", -- Kiểm tra vòi phun nước giếng có ít nhiên liệu
