...
local coconut_drink = {
	coconut_juice = {
		...
		priority = 2,
        health = TUNING.HEALING_SMALL*2, -- 9.375 -> 6 (30) 
...
local legion_drink = {
	pineananas_juice = {
		...
		priority = 2,
        health = (HEALING_MOREHUGE/2)/4, --9.375 (46.875)
...
local mfp_drink = {
	...
	strawberry_smoothie = {
		...
		priority = 2,
		health = TUNING.HEALING_TINY*7, -- 7 (35),
        hunger = TUNING.DRINK_CALORIES/2, -- 2.5 (12.5)
        sanity = TUNING.SANITY_SUPERTINY*2, -- 2 (10)
        thirst = TUNING.HYDRATION_MEDSMALL, -- 22.5
        perishtime = TUNING.PERISH_MED,
		temperature = TUNING.COLD_FOOD_CHILLING_THRESHOLD,
		temperatureduration = TUNING.FOOD_TEMP_AVERAGE,
