...
local function cookpot_archive(inst)
    ...
    inst.AnimState:PlayAnimation("idle_empty")
    inst.MiniMapEntity:SetIcon("portable_kettle.tex")
end
...
return MakeKittle("kittle", kittle, assets, prefabs),
    MakePlacer("cookpot_placer", "cook_pot", "cook_pot", "idle_empty"),
    MakeCookPot("portable_kettle", portable_kettle, assets_portable_kettle, prefabs)
