...
local growth_stages =
{
    {
        name = STAGE1,
        time = function(inst) return GetRandomWithVariance(TUNING.TEA_TREE_REGROW.EMPTY.BASE, TUNING.TEA_TREE_REGROW.EMPTY.VAR) end,
        fn = set_stage1,
        growfn = grow_to_stage1,
    },
    {
        name = STAGE2,
        time = function(inst) return GetRandomWithVariance(TUNING.TEA_TREE_REGROW.PREPICK.BASE, TUNING.TEA_TREE_REGROW.PREPICK.VAR) end,
        fn = set_stage2,
        growfn = grow_to_stage2,
    },
    {
        name = STAGE3,
        time = function(inst) return GetRandomWithVariance(TUNING.TEA_TREE_REGROW.PICK.BASE, TUNING.TEA_TREE_REGROW.PICK.VAR) end,
        fn = set_stage3,
        growfn = grow_to_stage3,
    },
    {
        name = STAGE4,
        time = function(inst) return GetRandomWithVariance(TUNING.TEA_TREE_REGROW.CRUMBLE.BASE, TUNING.TEA_TREE_REGROW.CRUMBLE.VAR) end,
        fn = set_stage4,
...
local function tea_tree()
    ...
    inst.components.pickable.max_cycles = TUNING.TEA_TREE_PICKABLE_CYCLES
