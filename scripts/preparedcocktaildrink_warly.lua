...
local drinks = {
    cocktail_bacardi = {
        test = function(boilier, names, tags) return names.madhu_rum and names.citroyuzu_juice and names.spice_sugar end,
        health = 0,
        hunger = 0,
        sanity = 0,
        thirst = 0,
    ...
    cocktail_void_alaska = {
        test = function(boilier, names, tags) return names.void_gin and names.citroyuzu_wine and names.citroyuzu_curacao end,
        health = 0,
        hunger = 0,
        sanity = 0,
        thirst = 0,
    ...
    cocktail_glow_martini_sweet = {
        test = function(boilier, names, tags) return names.glowberry_gin and names.petals_berry_brandy and (names.berries or names.berries_juicy) end,
        health = 0,
        hunger = 0,
        sanity = 0,
        thirst = 0,
    ...
    cocktail_fuse_parisian = {
        test = function(boilier, names, tags) return names.glowberry_gin and names.void_brandy and names.wine end,
        health = 0,
        hunger = 0,
        sanity = 0,
        thirst = 0,
...
for k, v in pairs(drinks) do
    ...
    v.boilbook_category = "portable_cocktail_maker"
