...
AddRecipe("campkettle",{Ingredient("twigs",2),Ingredient("log",2),Ingredient("cutgrass",2)},RECIPETABS.DRINKS_TAB,TECH.NONE,"campkettle_placer",nil,nil,nil,nil,"images/tea_inventoryitem.xml","campkettle.tex")
