...
AddRecipe2("bottle_pouch_big",{Ingredient("bottle_pouch_small",2,ModAtlas(),nil,"bottle_pouch_small.tex"),Ingredient("alterguardianhatshard",1),Ingredient("rope",2),Ingredient("goose_feather",1)},TECH.SCIENCE_TWO,{atlas = ModAtlas(), image = "bottle_pouch_big.tex"},{"COOKING","CONTAINERS","HYDRATION"})
