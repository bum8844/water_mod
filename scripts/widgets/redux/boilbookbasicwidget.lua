...
local BoilPage = require "widgets/redux/boilbookpage"
...
-------------------------------------------------------------------------------------------------------
local BoilbookBasicWidget = Class(Widget, function(self, parent)
...
function BoilbookBasicWidget:_PositionTabs(tabs, w, y)
...
function BoilbookBasicWidget:OnControlTabs(control, down)
...
function BoilbookBasicWidget:OnControl(control, down)
    if BoilbookBasicWidget._base.OnControl(self, control, down) then return true end

	return self:OnControlTabs(control, down)
end

function BoilbookBasicWidget:GetHelpText()
