...
-------------------------------------------------------------------------------------------------------
local BoilbookPage = Class(Widget, function(self, parent_screen, category)
    Widget._ctor(self, "BoilbookPage")

    self.parent_screen = parent_screen
	self.category = category or "kettle"
...
function BoilbookPage:_DoFocusHookups()
...
function BoilbookPage:CreateRecipeBook()
...
function BoilbookPage:_GetSpoilString(perishtime)
...
function BoilbookPage:_GetCookingTimeString(cooktime)
...
function BoilbookPage:_GetSideEffectString(recipe_def)
...
function BoilbookPage:PopulateRecipeDetailPanel(data)
...
function BoilbookPage:BuildRecipeBook()
    local base_size = 128
    local cell_size = 73
	...
	local boilbook_recipes = boilling.boilbook_recipes[self.category]
	for prefab, recipe_def in pairs(boilbook_recipes) do
...
function BoilbookPage:_sortfn_default(a, b)
...
function BoilbookPage:_sortfn_sideeffects(a, b)
...
function BoilbookPage:ApplyFilters()
...
function BoilbookPage:BuildSpinners()
